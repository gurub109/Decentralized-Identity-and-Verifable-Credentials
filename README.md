...
The internet is its current form has made it difficult to establish trust with others online, thus levaing the everyday users out of the value chain. Information and data, and the value they create are no longer owned and/or freely accessible by the users.

To fix the above fundamental problem, we need a system that inherently providers [Web of Trust](https://en.wikipedia.org/wiki/Web_of_trust) thus allowing users to control thier identities and to move thier personal data freely from one online system to other without fear of vendor lock-in. 
...
Verifiable Credentials form the foundation for verifiable data in the emerging web of trust. They can contain many different type of information as well as different type of credentials. Many software providers, institutions, governments, and businesses are implementing the technology in thier service offerings.
